...
// Menu / MenuItem / MenuButton / MenuAction / MenuBadge / MenuSkeleton / MenuSub / MenuSubItem / MenuSubButton
...
export function SidebarMenuBadge({ className, ...props }: React.ComponentProps<'div'>): React.JSX.Element {
  return (
    <div
