...
const AuthenticatedMcpsVirtualMcpsIdRoute = AuthenticatedMcpsVirtualMcpsIdRouteImport.update({
  id: '/virtual-mcps/$id',
  path: '/virtual-mcps/$id',
  getParentRoute: () => AuthenticatedMcpsRoute,
} as any);
const AuthenticatedMcpsProvidersIdRoute = AuthenticatedMcpsProvidersIdRouteImport.update({
  id: '/providers/$id',
  path: '/providers/$id',
  getParentRoute: () => AuthenticatedMcpsRoute,
} as any);
