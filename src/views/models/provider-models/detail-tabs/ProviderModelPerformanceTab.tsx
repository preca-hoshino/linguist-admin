...
interface ProviderModelPerformanceTabProps {
  readonly model: ProviderModel;
  readonly timeRange: GlobalTimeRange;
  readonly filterOptions: StatsFilterOptions;
}

export function ProviderModelPerformanceTab({
  model,
  timeRange,
  filterOptions,
}: ProviderModelPerformanceTabProps): React.JSX.Element {
