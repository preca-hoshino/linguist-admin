    ...
    <div className='rounded-lg border bg-card overflow-hidden'>
      ...
      >
        ...
        <div className='flex-1 min-w-0'>
          ...
          {subtitle != null && subtitle !== '' && <div className='text-[11px] text-muted-foreground mt-0.5'>{subtitle}</div>}
        </div>
        {isEmpty && (
          <span className='text-[11px] text-muted-foreground mr-2'>空</span>
        )}
...
export function LogMetadataTab({ log }: LogMetadataTabProps): React.JSX.Element {
  ...
  return (
    <div className='flex flex-col gap-3'>
      ...
      <JsonCard
        title={t('modelsPage.logs.detail.userRequest', '用户请求 Payload')}
      ...
      <JsonCard
        title={t('modelsPage.logs.detail.providerRequest', '提供商请求 Payload')}
      ...
      <JsonCard
        title={t('modelsPage.logs.detail.providerResponse', '提供商响应 Payload')}
      ...
      <JsonCard
        title={t('modelsPage.logs.detail.userResponse', '用户响应 Payload')}
      ...
      {log.cost_breakdown && (
        <JsonCard
          title={t('modelsPage.logs.detail.costBreakdown', '计费明细 Payload')}
          subtitle={
