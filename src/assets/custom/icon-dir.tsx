...
import type { Direction } from '@/providers/DirectionProvider';
...
export function IconDir({ dir, className, ...props }: Readonly<IconDirProps>): React.JSX.Element {
  return (
    <svg
      ...
      {...props}
    >
      <title>Icon Directory {dir}</title>
      <path
